...
class LightSource {
  ...
  static const LightSource top = LightSource(0, -1);
  static const LightSource topLeft = LightSource(-1, -1);
  static const LightSource topRight = LightSource(1, -1);
  static const LightSource bottom = LightSource(0, 1);
  static const LightSource bottomLeft = LightSource(-1, 1);
  static const LightSource bottomRight = LightSource(1, 1);
  static const LightSource left = LightSource(-1, 0);
  static const LightSource right = LightSource(1, 0);
